(defproject org.domaindrivenarchitecture.org/dda-liferay-crate "0.1.0-SNAPSHOT"
 :description "meissa-crates"
 :pallet {:source-paths ["src"]}
 :license {:name "Copyright meissa GmbH"}
 ...
 :repositories [["snapshots" "https://artifacts.meissa-gmbh.de:443/archiva/repository/snapshots/" :clojars]
                ["releases" "https://artifacts.meissa-gmbh.de/archiva/repository/internal/" :clojars]]
 :deploy-repositories [["snapshots" "https://artifacts.meissa-gmbh.de:443/archiva/repository/snapshots/"]
                       ["releases" "https://artifacts.meissa-gmbh.de/archiva/repository/internal/"]]
 :profiles {:dev
            {:dependencies
             [[com.palletops/pallet "0.8.0-RC.11" :classifier "tests"]
              ]
